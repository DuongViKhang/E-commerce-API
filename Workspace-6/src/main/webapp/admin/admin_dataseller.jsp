        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">DataSeller</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">DataTable of seller</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach var="i" begin="0" end="${size-1}">
                      <tr>
                      	  <td>${list[i].getStoreId()}</td>
                          <td>${list[i].getStoreName()}</td>
                          <td>${list[i].getUserId()}</td>
                          <td>${list[i].getBio()}</td>
                          <td>${list[i].getIsOpen()}</td>
                          <td>${list[i].getRating()}</td>
                      </tr>
                  </c:forEach>
                  </tbody>
                  <tfoot></tfoot>
