              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <c:forEach var="i" begin="0" end="${size-1}">
                      <tr>
                      	  <td>${listp[i].getProductId()}</td>
                      	  <td>${listp[i].getProductName()}</td>
                          <td>${listp[i].getQuantity()}</td>
                          <td>
                          	<c:set var= "j" value="${listp[i].getCategoryId()}"></c:set>
                          	${listc[j-1].getCategoryName()}
                          	<%-- ${listp[i].getStoreId()} --%>
                          </td>
                          <%-- <td>${listp[i].getCategoryId()}</td> --%>
                          <td>
                          	<c:set var= "k" value="${listp[i].getStoreId()}"></c:set>
                          	${lists[k-1].getStoreName()}
                          	<%-- ${listp[i].getStoreId()} --%>
                          </td>
                          <%-- <td>
                          <c:choose>
	                          	...
	                          	<c:when test="${listu[i].getRoleId() == 1003}">${listr[2].getRoleName()}</c:when>
	                      </c:choose>
	                      </td> --%>
                          <td>${listp[i].getRating()}</td>
                          <!-- <td><a href="#">Cấm</a></td> -->
                      </tr>
                  </c:forEach>
                  </tbody>
