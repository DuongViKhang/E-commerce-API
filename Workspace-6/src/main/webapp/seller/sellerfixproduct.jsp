...
<%--            <h1>${title}</h1>--%>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="http://localhost:8080/Shopee/seller">Home</a></li>
    ...
    <section class="content">
      ...
      <form method="post" action="fixproduct" id="AddProductForm"
              ...
              <div class="card card-primary">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter name"
                           name="masanpham" value="${product.productId}">
                  </div>
                  <div class="form-group">
                    <label>Tên sản phẩm</label>
                    <input type="text" class="form-control" placeholder="Enter name"
                           name="tensanpham" value="${product.productName}">
                  </div>
                  <div class="form-group">
                    <label>Mô tả ngắn</label>
                    <textarea class="form-control tiny" placeholder="Enter ..."
                              name="motasanpham" ">${product.decription}</textarea>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="0" max="100000000000" step="1" class="form-control"
                           name="inprice" value="${product.promotionalPrice}"/>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" min="0" max="100" step="1" class="form-control"
                           name="sale" value="${product.salePrice}"/>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2 select2-hidden-accessible"
                      ...
                      <c:forEach var="o" items="${listc}">
                        <option value="${o.categoryId}" ${o.categoryId == product.categoryId ? 'selected' : ''} >${o.categoryName}</option>
                      </c:forEach>
                    </select>
                  </div>
